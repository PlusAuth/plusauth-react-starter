...
This is a very simple React project demonstrating basic authentication flows such as register, login and logout. To keep things simple we bootstrapped the project with `create-react-app` and used `oidc-client` for authentication.
